...
## Submit und weitere Button

Es kann pro Form nur einen submit-Button geben!<br/>
Diese kann unterschiedlich implementiert werden:
...
```jsx
   ...
   ...
```
Beispiel für einen weiteren Button, der kein submit-Button ist:
...
Wird dieser gedrückt, so werden der Wert des Eingabefeldes und der Wert des Ergebnisses auf "" zurückgesetzt.<br/>
